#!/usr/bin/env bash
# Canonical LFM2 kernel A/B: llama-bench tg250, pp512 in-run, t4, 5 reps/arm.
set -euo pipefail
...
TSV="$RESULTS/lfm2-tg250-kernels.tsv"
LOG="$RESULTS/lfm2-tg250-kernels.log"
...
echo "=== tg250 kernel A/B started $RUN_TS ===" | tee -a "$LOG"
...
# Summary (mean of tg250 rows for this run_ts)
